...
function Curator() {
    ...
    return (
    <div className='page'>
        <div className='grid-tile' id='1'><CuratorForm source={img1}/></div>
        <div className='grid-tile' id='2'><CuratorForm source={img2}/></div>
        <div className='grid-tile' id='3'><CuratorForm source={img3}/></div>
        <div className='grid-tile' id='4'><CuratorForm source={img4}/></div>
        <div className='grid-tile' id='5'><CuratorForm source={img5}/></div>
        <div className='grid-tile' id='6'><CuratorForm source={img6}/></div>
        <div className='grid-tile' id='7'><CuratorForm source={img7}/></div>
    </div>
