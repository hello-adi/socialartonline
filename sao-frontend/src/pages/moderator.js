...
function Moderator() {
    ...
    return (
        <div className='page'>
            <div className='grid-tile' id='1'><ModForm source={img1}/></div>
            <div className='grid-tile' id='2'><ModForm source={img2}/></div>
            <div className='grid-tile' id='3'><ModForm source={img3}/></div>
            <div className='grid-tile' id='4'><ModForm source={img4}/></div>
            <div className='grid-tile' id='5'><ModForm source={img5}/></div>
            <div className='grid-tile' id='6'><ModForm source={img6}/></div>
            <div className='grid-tile' id='7'><ModForm source={img7}/></div>
        </div>
    );
  }
